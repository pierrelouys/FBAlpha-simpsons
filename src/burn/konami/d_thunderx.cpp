...
static unsigned char *pmcram;
static unsigned char thunderx_1f98_data;
...
static void scontra_bankswitch(int data)
{
	...
	int nBank = 0x10000 + (data & 0x0f) * 0x2000;

	konamiMapMemory(DrvKonROM + nBank, 0x6000, 0x7fff, SM_ROM);
}

static void thunderx_videobank(int data)
{
	nDrvKonamiBank[0] = data;
...
unsigned char scontra_main_read(unsigned short address)
{
	switch (address)
	{
		case 0x1f90:
...
static void thunderx_set_lines(int lines)
{
	nDrvKonamiBank[0] = lines;

	int nBank = 0x10000 + (((lines & 0x0f) ^ 0x08) * 0x2000);
...
struct BurnDriver BurnDrvScontra = {
	...
	NULL, scontraRomInfo, scontraRomName, ThunderxInputInfo, ScontraDIPInfo,
...
struct BurnDriver BurnDrvScontraj = {
	...
	NULL, scontrajRomInfo, scontrajRomName, ThunderxInputInfo, ScontraDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc,
	224, 288, 3, 4
};
...
static struct BurnRomInfo thnderxaRomDesc[] = {
...
STD_ROM_PICK(thnderxa)
STD_ROM_FN(thnderxa)

struct BurnDriver BurnDrvThnderxa = {
	"thnderxa", "thunderx", NULL, "1988",
	"Thunder Cross (set 2)\0", NULL, "Konami", "GX873",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_PREFIX_KONAMI, GBF_HORSHOOT, 0,
	NULL, thnderxaRomInfo, thnderxaRomName, ThunderxInputInfo, ThunderxDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc,
	288, 224, 4, 3
};
...
static struct BurnRomInfo thnderxbRomDesc[] = {
...
STD_ROM_PICK(thnderxb)
STD_ROM_FN(thnderxb)

struct BurnDriver BurnDrvThnderxb = {
	"thnderxb", "thunderx", NULL, "1988",
	"Thunder Cross (set 3)\0", NULL, "Konami", "GX873",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_PREFIX_KONAMI, GBF_HORSHOOT, 0,
	NULL, thnderxbRomInfo, thnderxbRomName, ThunderxInputInfo, ThunderxDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc,
	288, 224, 4, 3
};
...
static struct BurnRomInfo thnderxjRomDesc[] = {
...
STD_ROM_PICK(thnderxj)
STD_ROM_FN(thnderxj)

struct BurnDriver BurnDrvThnderxj = {
	"thnderxj", "thunderx", NULL, "1988",
	"Thunder Cross (Japan)\0", NULL, "Konami", "GX873",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE, 2, HARDWARE_PREFIX_KONAMI, GBF_HORSHOOT, 0,
	NULL, thnderxjRomInfo, thnderxjRomName, ThunderxInputInfo, ThunderxDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc,
	288, 224, 4, 3
};
