...
static struct BurnDIPInfo GbustersDIPList[]=
{
	...
	{0   , 0xfe, 0   ,    2, "Bullets"		},
	{0x12, 0x01, 0x04, 0x04, "50"			},
	{0x12, 0x01, 0x04, 0x00, "60"			},

	{0   , 0xfe, 0   ,    4, "Bonus Life"		},
	{0x12, 0x01, 0x18, 0x18, "50k, 200k & 400k"	},
	{0x12, 0x01, 0x18, 0x10, "70k, 250k & 500k"	},
	{0x12, 0x01, 0x18, 0x08, "50k"			},
	{0x12, 0x01, 0x18, 0x00, "70k"			},
...
unsigned char gbusters_main_read(unsigned short address)
{
	switch (address)
	{
		case 0x1f90:
...
void __fastcall gbusters_sound_write(unsigned short address, unsigned char data)
{
...
unsigned char __fastcall gbusters_sound_read(unsigned short address)
{
	if ((address & 0xfff0) == 0xb000) {
...
static void gbusters_set_lines(int lines)
{
...
{
	int layer_colorbase[3] = { 0x30, 0x00, 0x10 };
...
struct BurnDriver BurnDrvGbusters = {
	...
	NULL, gbustersRomInfo, gbustersRomName, GbustersInputInfo, GbustersDIPInfo,
...
struct BurnDriver BurnDrvGbustera = {
	...
	NULL, gbusteraRomInfo, gbusteraRomName, GbustersInputInfo, GbustersDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc,
	224, 288, 3, 4
};
...
struct BurnDriver BurnDrvCrazycop = {
	"crazycop", "gbusters", NULL, "1988",
	"Crazy Cop (Japan)\0", NULL, "Konami", "GX878",
	NULL, NULL, NULL, NULL,
	BDF_GAME_WORKING | BDF_CLONE | BDF_ORIENTATION_VERTICAL | BDF_ORIENTATION_FLIPPED, 2, HARDWARE_PREFIX_KONAMI, GBF_SHOOT, 0,
	NULL, crazycopRomInfo, crazycopRomName, GbustersInputInfo, GbustersDIPInfo,
	DrvInit, DrvExit, DrvFrame, DrvDraw, DrvScan, 0, NULL, NULL, NULL, &DrvRecalc,
	224, 288, 3, 4
};
