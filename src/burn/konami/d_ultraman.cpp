...
static struct BurnDIPInfo UltramanDIPList[]=
{
	...
	{0x15, 0x01, 0x40, 0x40, "Single"		},
	{0x15, 0x01, 0x40, 0x00, "Dual"			},
...
unsigned char __fastcall ultraman_read_byte(unsigned int address)
{
	...
	{
		case 0x1c0001:
			return (DrvInputs[0] & 0xef) | DrvDips[0];
